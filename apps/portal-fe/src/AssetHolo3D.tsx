import "./AssetHolo3D.css";

/* "Quản lý tài sản CNTT" — HOLOGRAM ĐỘI THIẾT BỊ.
   Laptop wireframe CSS-3D xoay giữa bệ hologram, 3 laptop mini bay quanh
   vành nét đứt = quản lý NHIỀU thiết bị. KHÔNG text (user chốt: chỉ cần
   laptop xoay). Thuần transform/opacity — nhẹ GPU, không lib/bitmap. */

export default function AssetHolo3D({ className }: { className?: string }) {
  return (
